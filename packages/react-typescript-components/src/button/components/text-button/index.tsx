...
const TextButton: FC<TextButtonProps> & {
  ...
  const TextJSX = useMemo(() => (size === Size.S ? <P2 text={text} /> : <P1 text={text} />), [size, text])
  ...
  return (
    <div className={clsx(
      ...
      },
      {
        ...
        'text-gray-400 hover:text-gray-400': disabled || (theme === THEME.photography && style === Style.LIGHT && !active && !disabled),
        'text-gray-200 hover:text-supportive-pastel': theme === THEME.photography && !active && !disabled,
        'text-gray-300 hover:text-gray-400': theme === THEME.photography && style === Style.LIGHT && active && !disabled,
        'text-gray-white hover:text-supportive-pastel': theme === THEME.photography && style === Style.DARK && active && !disabled,
        'text-supportive-faded hover:text-supportive-pastel': theme === THEME.photography && style === Style.BRAND && active && !disabled,
