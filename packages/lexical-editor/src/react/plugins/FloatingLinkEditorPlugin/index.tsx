...
import type { JSX, Dispatch, ChangeEvent, KeyboardEvent } from 'react'
    ...
    <div ref={editorRef} className="link-editor">
      {!isLink ? null : isLinkEditMode ? (
        <>
          ...
          <div>
            <div
              className="icon button link-cancel"
              role="button"
              tabIndex={0}
            ...
            <div
              className="icon button link-confirm"
              role="button"
              tabIndex={0}
              onMouseDown={preventDefault}
        ...
        <div className="link-view">
          ...
          <div
            className="icon button link-edit"
            role="button"
            tabIndex={0}
            onMouseDown={preventDefault}
            onClick={(event) => {
          ...
          />
          <div
            className="icon button link-trash"
            role="button"
            tabIndex={0}
            onMouseDown={preventDefault}
            onClick={() => {
